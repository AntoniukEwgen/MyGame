...
namespace Vampire
{
    public class LevelManager : MonoBehaviour
    {
        ...
        [SerializeField] private WinGameDialog winGameDialog;
        [SerializeField] private LevelUnlocker unlocker;
        ...
        void Update()
        {
            ...
            // Boss spawning
            if (!miniBossSpawned && levelBlueprint.miniBosses != null && levelBlueprint.miniBosses.Length > 0 && levelTime > levelBlueprint.miniBosses[0].spawnTime)
            {
        ...
        {
            Time.timeScale = 0;
            unlocker.UnlockLevel();
            int coinCount = PlayerPrefs.GetInt("Coins");
            PlayerPrefs.SetInt("Coins", coinCount + statsManager.CoinsGained);
            winGameDialog.Open(true, statsManager);
        }
