...
public class SoundPlayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AddSound("Chest", Resources.Load<AudioClip>(SoundPath + "Chest"));
        AddSound("Coin", Resources.Load<AudioClip>(SoundPath + "Coin"));
        AddSound("EnemyDie", Resources.Load<AudioClip>(SoundPath + "EnemyDie"));
        AddSound("Exp", Resources.Load<AudioClip>(SoundPath + "Exp"));
        AddSound("LevelUP", Resources.Load<AudioClip>(SoundPath + "LevelUP"));
    }
}